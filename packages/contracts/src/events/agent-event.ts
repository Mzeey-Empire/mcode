...
const AgentEventPayloadSchema = z.discriminatedUnion("type", [
    ...
    z.object({
      ...
      /** Image or file attachments generated by the assistant during this turn. */
      attachments: z.array(StoredAttachmentSchema()).optional(),
    }),
    z.object({
      /** Server-internal event for generated files that will attach to the assistant message. */
      type: z.literal(AgentEventType.GeneratedAttachment),
      threadId: z.string(),
      attachment: StoredAttachmentSchema(),
    }),
    z.object({
